...
<div class="ibox">
        ...
        <div class="ibox-body">
            <form class="form-group" method="post" action="{{ route('team_member.store') }}"  enctype="multipart/form-data">
                @csrf
            	<div class="row">
                 <div class="col-md-7">
                 ...
                 <div class="col-md-5">
                    ...
                    <input name="position" class="form-control input-rounded" type="text">
                    @error('position')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <button class="btn btn-success btn-block" type="submit"><h2>Add Member</h2></button>
            </form>
        </div>
    </div>
@endsection
